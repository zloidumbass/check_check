    ...
    try {
      ...
      if (nomenclature!=null) {
        for (var nomenclature_element in nomenclature) {
          String ell = '{"id":${nomenclature_element
              .id},"accepted":${nomenclature_element.accepted.toString()}}';
          body_list.add(ell);
        }
      }
      String json_body = '{"type":"edit","datetime":"${widget.value.date_time}","s":"${widget.value.sum}","fn":"${widget.value.fn}","fd":"${widget.value.fd}","fpd":"${widget.value.fpd}", "verified":${verified}, "nomenclature":${body_list.toString()}}';
              ...
              children: <Widget>[
                new Container(
                    ...
                    child: Center(
                        child: Padding(
                          ...
                          child: Text(
                              widget.value.name,style: TextStyle(fontSize: 24),textAlign: TextAlign.left
                          ),
                        )
                    )
                ),
                Column(
                    children: <Widget>[
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 0,top: 10,right: 0,left: 0), child: Text('ФИО',style: TextStyle(fontSize: 16),textAlign: TextAlign.left), )
                      ),
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 10,top: 0,right: 0,left: 0), child: Text(widget.value.full_name,style: TextStyle(fontSize: 14, color: Colors.grey,),textAlign: TextAlign.left), )
                      )
                    ]
                ),
                Column(
                    children: <Widget>[
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 0,top: 10,right: 0,left: 0), child: Text('Номенклатура',style: TextStyle(fontSize: 16),textAlign: TextAlign.left), )
                      ),
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 10,top: 0,right: 0,left: 0), child: CreateTable(), )
                      )
                    ]
                ),
                ...
                Column(
                    children: <Widget>[
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 0,top: 10,right: 0,left: 0), child: Text('Сумма',style: TextStyle(fontSize: 16),textAlign: TextAlign.left), )
                      ),
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 10,top: 0,right: 0,left: 0), child: Text(widget.value.doc_sum,style: TextStyle(fontSize: 14, color: Colors.grey,),textAlign: TextAlign.left), )
                      )
                    ]
                ),
                ...
                Column(
                    children: <Widget>[
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 0,top: 10,right: 0,left: 0), child: Text('Статус',style: TextStyle(fontSize: 16),textAlign: TextAlign.left), )
                      ),
                      new Container(
                          width: MediaQuery.of(context).size.width,
                          child: Padding(padding: EdgeInsets.only(bottom: 10,top: 0,right: 0,left: 0), child: Text(widget.value.status, maxLines: null, style: TextStyle(fontSize: 14, color: Colors.grey,),textAlign: TextAlign.left), )
                      )
                    ]
                ),
                new Container(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return Container(height: MediaQuery.of(context).size.height*0.3,
                decoration:
                new BoxDecoration(border: Border.all(color: Colors.black12)),
          ...
          title: new Row(
            ...
            children: <Widget>[
              ...
              CupertinoSwitch(
                ...
                onChanged: (bool value) { setState(() { nomenclature.accepted = value; }); },
              ),
            ],
          ),
          onTap: () { setState(() { nomenclature.accepted = !nomenclature.accepted; }); },
        )
      ]),
    );
  }
